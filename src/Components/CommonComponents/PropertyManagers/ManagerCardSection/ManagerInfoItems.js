...
const ManagerInfoItems = () => {
  ...
  return (
    <div className="flex justify-center ">
      ...
      <div
        className="
            my-auto mx-auto  px-2 py-2 cursor-pointer opacity-50 hover:opacity-100 "
        onClick={sliderLeft}
      >
        <img
          src="./images/propertyManagers/arrow.png"
          alt="arrow-reverse"
          className=" rotate-180 w-[1rem]"
        />
      </div>

      <div
        id="slider"
        className=" flex w-[70rem]  justify-start px-2 gap-[4rem]  overflow-hidden scroll-smooth  
            md:gap-x-[5rem]
            md:justify-start
            "
      >
          ...
          return (
            <div className="w-[19.75em] px-[3rem] h-[18.375rem]  bg-white rounded-md shadow-lg ">
              ...
              <div className="flex justify-between w-full gap-x-2">
                <CallBtn />
                <button
                  className="text-footerSubGrey2 bg-none w-[3.938rem] px-[0.3rem] text-[0.57rem] rounded-md font-bold border-footerSubGrey2 border-opacity-80 border-[0.1rem] hover:opacity-50"
                  onClick={() => {
